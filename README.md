...
- Hermes Desktop 在 Windows 上走官方桌面安装器路径，不要求用户先手装 Python
...
- Hermes Desktop follows the official Windows desktop installer path, so users do not need to preinstall Python first
